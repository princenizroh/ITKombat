        ...
        private void AttackAnimation(Collider2D[] hitEnemies, bool isBlocked)
        {
            ...
            switch (combo)
            {
                case 1:
                    ...
                    soundPlayerKimia.Instance.PlayAttackSound(1, hitEnemies.Length > 0, isBlocked);
                ...
                case 2:
                    ...
                    soundPlayerKimia.Instance.PlayAttackSound(2, hitEnemies.Length > 0, isBlocked);
                ...
                case 3:
                    ...
                    soundPlayerKimia.Instance.PlayAttackSound(3, hitEnemies.Length > 0, isBlocked);
                ...
                case 4:
                    ...
                    soundPlayerKimia.Instance.PlayAttackSound(4, hitEnemies.Length > 0, isBlocked);
