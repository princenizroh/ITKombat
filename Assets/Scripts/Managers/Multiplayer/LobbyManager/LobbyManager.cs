...
namespace ITKombat
{
    public class LobbyManager : MonoBehaviour
    {
        ...
        private async void Start() 
        {
            ...
            InitializeFirebase();  // Inisialisasi Firebase
        ...
        private void AuthStateChanged(object sender, System.EventArgs eventArgs)
        {
            if (auth.CurrentUser != user)
            {
                ...
                if (user != null)
                {
                    ...
                    playerName = "Player_" + user.UserId;  // Gunakan Firebase User ID saat login
                }
            }
        }
        ...
        private Player GetPlayer()
        {
            return new Player
            {
                // Jangan gunakan player.Id karena properti ini read-only
                Data = new Dictionary<string, PlayerDataObject>
                {
                    ...
                    { 
                        "FirebaseUserId", new PlayerDataObject(PlayerDataObject.VisibilityOptions.Member, user.UserId)  // Menyimpan Firebase User ID di sini
                    }
                }
            };
        }
